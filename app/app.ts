...
export const apiInitErrorResultToMessage = (resultCode: obs.EVideoCodes) => {
  switch (resultCode) {
    case obs.EVideoCodes.NotSupported: {
      return 'Failed to initialize The Eden Desktop. Your video drivers may be out of date, or The Eden Desktop may not be supported on your system.';
    }
    ...
    default: {
      return 'An unknown error was encountered while initializing The Eden Desktop.';
    }
  }
};
