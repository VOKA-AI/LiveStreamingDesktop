...
function DestinationSwitcher(p: IDestinationSwitcherProps) {
  ...
  function onClickHandler(ev: MouseEvent) {
    if (p.isPrimary) {
      alertAsync(
        $t(
          'You cannot disable the platform you used to sign in to The Eden Desktop. Please sign in with a different platform to disable streaming to this destination.',
        ),
      );
      return;
    }
