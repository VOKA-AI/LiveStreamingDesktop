      ...
      <div>
        <div class="section">
          <div class="section-content">
            ...
            <p>
              {$t(
                'Virtual Webcam allows you to display your scenes from The Eden Desktop in video conferencing software. The Eden Desktop will appear as a Webcam that can be selected in most video conferencing apps.',
              )}
            </p>
          </div>
        </div>
